//
//  CSNewResetPasswordsViewController.m
//  ColorStar
//
...
@interface CSNewResetPasswordsViewController ()<UITextFieldDelegate>
...
@implementation CSNewResetPasswordsViewController
...
- (void)sendButtonClick:(UIButton *)btn{
    if (self.checkButton.isSelected) {
        [[CSNewLoginNetManager sharedManager] getRestPwdWithPhone:self.phoneaNum.text withPws:self.passworldNum.text withCode:self.verifyCodeNum.text Complete:^(CSNetResponseModel * _Nonnull response) {
