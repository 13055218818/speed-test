...
- (void)setupUI {
    ...
    fl.itemSize = CGSizeMake(self.view.width, ScreenH * 0.8 - y);
    fl.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    fl.collectionView.showsHorizontalScrollIndicator = NO;
    fl.minimumLineSpacing = 0;
    fl.minimumInteritemSpacing = 0;
    UICollectionView *pageCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, y, self.view.width, ScreenH * 0.8 - y) collectionViewLayout:fl];
