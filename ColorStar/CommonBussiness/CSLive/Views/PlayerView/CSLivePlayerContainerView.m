...
@interface CSLivePlayerContainerView ()
...
@implementation CSLivePlayerContainerView
...
- (void)layoutSubviews {
    ...
    _scaleModeBtn.frame = CGRectMake(_bottomControlView.width - kPlayerBtnWidth - 10, 0, kPlayerBtnWidth, _bottomControlView.height);
