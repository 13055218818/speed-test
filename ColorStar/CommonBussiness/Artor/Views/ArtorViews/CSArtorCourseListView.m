...
@interface CSArtorCourseListItemCell : UITableViewCell
...
@implementation CSArtorCourseListItemCell
...
NSString * const CSArtorCourseListItemCellReuseIdentifier = @"CSArtorCourseListItemCellReuseIdentifier";

@interface CSArtorCourseListView ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)UITableView * tableView;

@end

@implementation CSArtorCourseListView
...
- (void)setUpViews{
    ...
    [self.tableView registerClass:[CSArtorCourseListItemCell class] forCellReuseIdentifier:CSArtorCourseListItemCellReuseIdentifier];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CSArtorCourseListItemCell * itemCell = [tableView dequeueReusableCellWithIdentifier:CSArtorCourseListItemCellReuseIdentifier forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CSArtorCourseRowModel * rowModel = self.courses[indexPath.row];
    if (self.courseClick) {
        self.courseClick(rowModel,indexPath);
    }
