...
NSString * const CSMineCourseCellReuseIdentifier4 = @"CSMineCourseCellReuseIdentifier4";
NSString * const CSEmptyDataCellReuseIdentifier3 = @"CSEmptyDataCellReuseIdentifier3";

@interface CSMyFavoriteViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation CSMyFavoriteViewController
...
- (void)loadData{
    ...
    [[CSNetworkManager sharedManager] quaryFavoriteListSuccessComplete:^(CSNetResponseModel * response) {
...
- (void)setupTableView{
    ...
    [self.tableView registerClass:[CSMineCourseCell class] forCellReuseIdentifier:CSMineCourseCellReuseIdentifier4];
    [self.tableView registerClass:[CSEmptyDataCell class] forCellReuseIdentifier:CSEmptyDataCellReuseIdentifier3];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.list.count > 0) {
        CSMineCourseCell * cell = [tableView dequeueReusableCellWithIdentifier:CSMineCourseCellReuseIdentifier4 forIndexPath:indexPath];
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        CSCourseBasicModel * baseModel = self.list[indexPath.row];
        [cell configModel:baseModel];
        return cell;
    }else{
        CSEmptyDataCell * emptyCell = [tableView dequeueReusableCellWithIdentifier:CSEmptyDataCellReuseIdentifier3 forIndexPath:indexPath];
        return emptyCell;
    }
